...
class ActionLayer(BaseActionLayer):
    ...
    def _inconsistent_effects(self, actionA, actionB):
        ...
        #Check if an effect of actionA negates an effect of the actionB
        effect_A_negates_B = any(~effect in actionB.effects for effect in actionA.effects)
        #Check if an effect of actionB negates an effect of the actionA
        effect_B_negates_A = any(~effect in actionA.effects for effect in actionB.effects)
        
        return (effect_A_negates_B or effect_B_negates_A)
    ...
    def _interference(self, actionA, actionB):
        ...
        """
        # TODO: implement this function
        #Check if effects of actionA negates the preconditions of the actionB
        effectA_preconditionsB=any(~effect in actionB.preconditions for effect in actionA.effects)
        #Check if effects of actionB negates the preconditions of the actionA
        effectB_preconditionsA=any(~effect in actionA.preconditions for effect in actionB.effects)

        return (effectA_preconditionsB or effectB_preconditionsA)
    ...
    def _competing_needs(self, actionA, actionB):
        ...
        """
        # TODO: implement this function
        isMutex=any(self.parent_layer.is_mutex(i,j) for j in self.parents[actionB] for i in self.parents[actionA])
...
class LiteralLayer(BaseLiteralLayer):
    ...
    def _inconsistent_support(self, literalA, literalB):
        ...
        """
        # TODO: implement this function
        all_pairwise_mutex = all(self.parent_layer.is_mutex(i,j) for j in self.parents[literalB] for i in self.parents[literalA])
